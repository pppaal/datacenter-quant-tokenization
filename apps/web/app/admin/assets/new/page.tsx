    ...
    <div className="grid gap-6 xl:grid-cols-[0.78fr_1.22fr]">
      <Card className="hero-mesh h-fit">
        ...
        <p className="mt-4 text-sm leading-7 text-slate-400">
          Capture the institutional intake record first, then move the asset through enrichment,
          evidence review, valuation, IC material, and registry-ready packaging.
        </p>
        <div className="mt-6 grid gap-3">
          {[
            ...
            <div
              key={item}
              className="rounded-[22px] border border-white/10 bg-slate-950/45 p-4 text-sm text-slate-300"
            >
              {item}
            </div>
          ))}
