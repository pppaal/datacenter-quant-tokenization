...
function makeProForma(): ProFormaBaseCase {
  const makeYear = (year: number, noi: number, dist: number) => ({
    year, occupiedKw: 10, contractedKw: 6, residualOccupiedKw: 4,
    ...
    fitOutCostKrw: 50, noiKrw: noi, cfadsBeforeDebtKrw: noi - 200,
    ...
    endingDebtBalanceKrw: 2500, dscr: (noi - 200) / 500,
    propertyTaxKrw: 50, insuranceKrw: 30, managementFeeKrw: 40,
    reserveContributionKrw: 0, corporateTaxKrw: 100, afterTaxDistributionKrw: dist
  });
  ...
  return {
    summary: {
      ...
      endingDebtBalanceKrw: 2500, grossExitValueKrw: 55000, netExitProceedsKrw: 48000,
      leveredEquityValueKrw: 40000, equityIrr: 15, unleveragedIrr: 12,
      equityMultiple: 2.5, averageCashOnCash: 8.0, paybackYear: 2,
      peakEquityExposureKrw: 5000, initialEquityKrw: 5000, initialDebtFundingKrw: 5000
    },
