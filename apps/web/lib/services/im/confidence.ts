...
export function buildConfidenceBreakdown(
  ...
  const flood =
    (bundle as { siteProfile?: { floodRiskScore?: number | null } }).siteProfile?.floodRiskScore ??
    0;
  const wildfire =
    (bundle as { siteProfile?: { wildfireRiskScore?: number | null } }).siteProfile
      ?.wildfireRiskScore ?? 0;

  const signals: ConfidenceSignal[] = [
    // External sections (×0.65 each in DC engine)
    {
      group: 'External sections',
      label: 'Site profile',
      present: presentObj(bundle.siteProfile),
      weight: 0.65,
      direction: 'add'
    },
    {
      ...
      present: presentObj(bundle.buildingSnapshot),
      weight: 0.65,
      direction: 'add'
    },
    {
      ...
      present: presentObj(bundle.permitSnapshot),
      weight: 0.65,
      direction: 'add'
    },
    {
      ...
      present: presentObj(bundle.energySnapshot),
      weight: 0.65,
      direction: 'add'
    },
    {
      ...
      present: presentObj(bundle.marketSnapshot),
      weight: 0.65,
      direction: 'add'
    },
    ...
    // Structured sections (×0.45 each)
    {
      ...
      label: 'Comparable set populated',
      present: presentArr(bundle.comparableSet?.entries) > 0,
      weight: 0.45,
      direction: 'add'
    },
    {
      group: 'Structured sections',
      label: 'Capex line items',
      present: presentArr(bundle.capexLineItems) > 0,
      weight: 0.45,
      direction: 'add'
    },
    {
      group: 'Structured sections',
      label: 'Leases on file',
      present: presentArr(bundle.leases) > 0,
      weight: 0.45,
      direction: 'add'
    },
    {
      ...
      present: presentObj(bundle.taxAssumption),
      weight: 0.45,
      direction: 'add'
    },
    {
      group: 'Structured sections',
      label: 'SPV structure',
      present: presentObj(bundle.spvStructure),
      weight: 0.45,
      direction: 'add'
    },
    {
      ...
      present: presentArr(bundle.debtFacilities) > 0,
      weight: 0.45,
      direction: 'add'
    },
    ...
    {
      group: 'Geo & price anchors',
      label: 'Lat/long resolved',
      present: typeof bundle.address?.latitude === 'number',
      weight: 0.25,
      direction: 'add'
    },
    {
      group: 'Geo & price anchors',
      label: 'Purchase price set',
      present: typeof bundle.purchasePriceKrw === 'number' && (bundle.purchasePriceKrw ?? 0) > 0,
      weight: 0.2,
      direction: 'add'
    },
    {
      group: 'Geo & price anchors',
      label: 'Stabilized occupancy set',
      present:
        typeof bundle.stabilizedOccupancyPct === 'number' &&
        (bundle.stabilizedOccupancyPct ?? 0) > 0,
      weight: 0.2,
      direction: 'add'
    },
    ...
    {
      group: 'Risk penalties',
      label: `Flood risk ×${flood.toFixed(1)}`,
      present: flood > 0,
      weight: Number((flood * 0.05).toFixed(2)),
      direction: 'subtract'
    },
    {
      group: 'Risk penalties',
      label: `Wildfire risk ×${wildfire.toFixed(1)}`,
      present: wildfire > 0,
      weight: Number((wildfire * 0.04).toFixed(2)),
      direction: 'subtract'
    }
  ];
