...
const DISTRICT_RULES: DistrictRule[] = [
  ...
  {
    match: /압구정/,
    zone: 'COMMERCIAL_GENERAL',
    primary: '일반상업지역',
    specialDistrict: '압구정로데오 지구단위계획구역'
  },
  { match: /청담/, zone: 'COMMERCIAL_GENERAL', primary: '일반상업지역' },
  { match: /신사/, zone: 'COMMERCIAL_GENERAL', primary: '일반상업지역' },
  {
    match: /잠실/,
    zone: 'COMMERCIAL_CENTRAL',
    primary: '중심상업지역',
    specialDistrict: '잠실광역중심'
  },
  {
    match: /여의도/,
    zone: 'COMMERCIAL_CENTRAL',
    primary: '중심상업지역',
    specialDistrict: '국제금융지구'
  },
  {
    match: /광화문|종로/,
    zone: 'COMMERCIAL_CENTRAL',
    primary: '중심상업지역',
    specialDistrict: '도심부 지구단위계획구역'
  },
  {
    match: /역삼|테헤란/,
    zone: 'COMMERCIAL_GENERAL',
    primary: '일반상업지역',
    specialDistrict: '테헤란로 지구단위계획구역'
  },

  // Seoul semi-industrial
  {
    match: /성수/,
    zone: 'INDUSTRIAL_QUASI',
    primary: '준공업지역',
    specialDistrict: '성수IT산업개발진흥지구'
  },
  {
    match: /가산|구로디지털/,
    zone: 'INDUSTRIAL_QUASI',
