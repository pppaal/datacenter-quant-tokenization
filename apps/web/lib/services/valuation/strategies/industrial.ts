...
export async function buildIndustrialValuationAnalysis(
  ...
  const analysis: UnderwritingAnalysis = {
    ...
    underwritingMemo: '',
    keyRisks: buildStabilizedIncomeKeyRisks(bundle, valuation, industrialRiskConfig),
    ddChecklist: buildStabilizedIncomeDdChecklist(industrialDdChecklistBase, debtDdChecklistItem),
