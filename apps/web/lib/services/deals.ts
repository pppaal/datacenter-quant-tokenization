...
// Import view-layer builders + helpers so internal callers in this file
// keep working without refactoring every call site to the new module.
// Re-exported below for legacy `import { ... } from '@/lib/services/deals'`
// consumers.
import {
