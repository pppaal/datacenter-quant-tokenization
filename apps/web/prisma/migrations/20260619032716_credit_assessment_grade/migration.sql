-- AAA–CCC letter grade + 1yr PD + investment-grade flag on the credit
-- assessment, populated from the tenant-credit engine at ingest.
--
...
-- AlterTable
ALTER TABLE "CreditAssessment" ADD COLUMN     "grade" TEXT,
ADD COLUMN     "investmentGrade" BOOLEAN,
ADD COLUMN     "pdPct" DOUBLE PRECISION;
