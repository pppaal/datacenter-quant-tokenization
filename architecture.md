...
- Korean macro and rates inputs: cap rates, colocation pricing, debt cost, inflation, and construction cost benchmarks
...
- Asset intake fields: asset code, asset name, owner and sponsor, development summary, target IT load, power capacity, land area, gross floor area, occupancy assumptions, capex, opex, and financing assumptions
...
The current platform keeps files, diligence logic, underwriting workflows, and most business logic offchain. The intended phase-2 onchain surface is limited to institutional registry functions such as asset identifiers and document-hash anchoring.
